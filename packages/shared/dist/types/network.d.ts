 ...
 */
export type EntitySnapshot = ChampionSnapshot | MinionSnapshot | TowerSnapshot | ProjectileSnapshot | NexusSnapshot | JungleCreatureSnapshot | WardSnapshot | ZoneSnapshot | LightOrbSnapshot;
/**
