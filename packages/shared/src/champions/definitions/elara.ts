...
export const ElaraBarrier: AbilityDefinition = {
  ...
  name: "Sacred Shield",
  description:
    "Grant target ally a shield absorbing {shield} damage for 2.5 seconds.",
  type: "active",
  targetType: "target_ally",
  maxRank: 5,
...
export const ElaraSpeed: AbilityDefinition = {
  ...
  name: "Swift Grace",
  description:
    "Grant yourself and nearby allies 30% bonus movement speed for 2 seconds.",
  type: "active",
...
export const ElaraResurrection: AbilityDefinition = {
  ...
  description:
    "Heal all allies in range for {heal} health and cleanse all debuffs.",
  type: "active",
  targetType: "no_target",
  maxRank: 3,
...
export const ElaraPassive: PassiveAbilityDefinition = {
  ...
  description:
    "Nearby allies within 600 units heal 1% of their max health per second.",
  trigger: "always",
  auraRadius: 600,
  heal: {
