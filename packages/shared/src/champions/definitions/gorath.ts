...
export const GorathSlam: AbilityDefinition = {
  ...
  name: "Ground Slam",
  description:
    "Slam the ground, dealing {damage} magic damage and slowing enemies by 40% for 1 second.",
  type: "active",
...
export const GorathTaunt: AbilityDefinition = {
  ...
  name: "Defiant Roar",
  description:
    "Taunt all nearby enemies, forcing them to attack you for 1.5 seconds.",
  type: "active",
  targetType: "no_target",
  maxRank: 5,
...
export const GorathEarthquake: AbilityDefinition = {
  ...
  name: "Earthquake",
  description:
    "Create a massive earthquake dealing {damage} magic damage and knocking up all enemies for 1 second.",
  type: "active",
  targetType: "no_target",
  maxRank: 3,
...
export const GorathPassive: PassiveAbilityDefinition = {
  ...
  name: "Immovable",
  description:
    "When taking damage, gain 5 armor (max 10 stacks). Stacks decay after 4 seconds out of combat.",
