...
export const VileBlackArrows: AbilityDefinition = {
  ...
  description:
    "Charge to fire an arrow that deals {damage} physical damage and slows by 50% for 2 seconds. Hit location can be dashed to by recasting.",
  type: "active",
...
export const VileVeilOfDarkness: AbilityDefinition = {
  ...
  description:
    "Become invisible and invulnerable for 2 seconds but cannot move. After the veil ends, gain 50% movement speed and slow resistance for 2 seconds.",
  type: "active",
  targetType: "self",
  maxRank: 5,
...
export const VileRootsOfVilix: AbilityDefinition = {
  ...
  name: "Roots of Vilix",
  description:
    "Place an invisible trap that roots enemy champions for 1 second and grants Vile 5 soul stacks. Stores up to 5 charges.",
  type: "active",
...
export const VileRestorationOfVilix: AbilityDefinition = {
  ...
  description:
    "Transform for 10 seconds, gaining massive stats, melee range, and an aura that damages nearby enemies. Grants 100 soul stacks and causes all traps to explode.",
  type: "active",
  targetType: "self",
  maxRank: 3,
  ...
  statTransform: {
    ...
    statModifiers: {
      ...
      attackSpeed: [0.3, 0.45, 0.6], // Percent bonus
      movementSpeed: [0.2, 0.3, 0.4], // Percent bonus
    },
  ...
  aura: {
    ...
    damage: {
      type: "magic",
      scaling: scaling([25, 40, 55], { apRatio: 0.2 }),
    },
...
export const VilePassive: PassiveAbilityDefinition = {
  ...
  name: "Souls of Vilix",
  description:
    "Killing enemies grants soul stacks. Basic attacks against champions consume all stacks to deal bonus physical damage.",
