...
function generate() {
  ...
  const astronaurs = generateAstronauts(
    new Vector(85, -1515),
    new Vector(270, -1510),
    new Vector(-1415, 1145)
  );
  const objects: BaseObject[] = [sun, mars, ...astronaurs];

  const level = new Level(
    objects,
    new LandingOnTargetPlanetObjective(mars),
    new Rectangle(20000, 20000)
  );
