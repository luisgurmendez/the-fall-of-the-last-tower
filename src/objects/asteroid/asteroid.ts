...
const AsteroidMixins = CollisionableMixin<Rectangle>()(
...
function generateRandomAsteroidShape(w: number, h: number, s: number) {
  ...
  shape.push(
    new Vector(
      -1 * RandomUtils.getIntegerInRange(0, _w),
      RandomUtils.getIntegerInRange(0, _h)
    )
  );
  ...
  shape.push(
    new Vector(
      RandomUtils.getIntegerInRange(0, _w),
      RandomUtils.getIntegerInRange(0, _h)
    )
  );
  ...
  shape.push(
    new Vector(
      RandomUtils.getIntegerInRange(0, _w),
      -1 * RandomUtils.getIntegerInRange(0, _h)
    )
  );
